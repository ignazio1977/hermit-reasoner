...
public abstract class AbstractOntologyTest extends AbstractHermiTTest {
    ...
    protected Tableau getTableau(Collection<DescriptionGraph> descriptionGraphs) {
     ...
     * with the given string
     */
    protected void assertEquals(Set<OWLAxiom> axioms, String controlResourceName1, String controlResourceName2)
            throws Exception {
        String axiomsString = axioms.toString().trim();
    ...
    protected OWLObjectSomeValuesFrom SVF(OWLObjectPropertyExpression objectPropertyExpression,
            OWLClassExpression classExpression) {
        return m_dataFactory.getOWLObjectSomeValuesFrom(objectPropertyExpression, classExpression);
    }

    protected OWLObjectAllValuesFrom AVF(OWLObjectPropertyExpression objectPropertyExpression,
            OWLClassExpression classExpression) {
