...
public class ClausificationDatatypesTest extends AbstractStructuralTest {
    ...
    public void testDataPropertiesAll1() throws Exception {
        ...
        loadOntologyWithAxioms(axioms);
        List<String> clauses = getDLClauses();
        assertContainsAll(this.getName(), clauses, S("xsd:integer(Y) :- :A(X), :dp(X,Y)"));
    }
    ...
    public void testDataPropertiesAll2() throws Exception {
        ...
        loadOntologyWithAxioms(axioms);
        List<String> clauses = getDLClauses();
        assertContainsAll(this.getName(), clauses, S(":A(X) v atLeast(1 :dp not(xsd:integer))(X) :- owl:Thing(X)"));
    }
    ...
    public void testDataPropertiesSome1() throws Exception {
        ...
        loadOntologyWithAxioms(axioms);
        List<String> clauses = getDLClauses();
        assertContainsAll(this.getName(), clauses, S(":A(X) v not(xsd:string)(Y) :- :dp(X,Y)"));
    }
    ...
    public void testDataPropertiesSome2() throws Exception {
        ...
        loadOntologyWithAxioms(axioms);
        List<String> clauses = getDLClauses();
        assertContainsAll(this.getName(), clauses, S("atLeast(1 :dp xsd:string)(X) :- :A(X)"));
    }
    ...
    public void testDataPropertiesMax2() throws Exception {
        ...
        loadOntologyWithAxioms(axioms);
        List<String> clauses = getDLClauses();
        assertContainsAll(this.getName(), clauses, S(":A(X) v atLeast(2 :dp xsd:string)(X) :- owl:Thing(X)"));
    }
    ...
    public void testDataPropertiesMax3() throws Exception {
        ...
        assertContainsAll(this.getName(), clauses, S(
                "Y1 == Y2 v Y1 == Y3 v Y1 == Y4 v Y2 == Y3 v Y2 == Y4 v Y3 == Y4 v not(xsd:integer)(Y1) v not(xsd:integer)(Y2) v not(xsd:integer)(Y3) v not(xsd:integer)(Y4) :- :A(X), :dp(X,Y1), :dp(X,Y2), :dp(X,Y3), :dp(X,Y4)"));
    }
    ...
    public void testDataPropertiesMax4() throws Exception {
        ...
        loadOntologyWithAxioms(axioms);
        List<String> clauses = getDLClauses();
        assertContainsAll(this.getName(), clauses, S(":A(X) v atLeast(4 :dp xsd:integer)(X) :- owl:Thing(X)"));
    }
    ...
    public void testDataPropertiesMin2() throws Exception {
        ...
        List<String> clauses = getDLClauses();
        assertContainsAll(this.getName(), clauses, S(
                ":A(X) v Y1 == Y2 v Y1 == Y3 v Y2 == Y3 v not(xsd:string)(Y1) v not(xsd:string)(Y2) v not(xsd:string)(Y3) :- :dp(X,Y1), :dp(X,Y2), :dp(X,Y3)"));
    }
    ...
    public void testDataPropertiesMin4() throws Exception {
        ...
        loadOntologyWithAxioms(axioms);
        List<String> clauses = getDLClauses();
        assertContainsAll(this.getName(), clauses, S("atLeast(5 :dp xsd:string)(X) :- :A(X)"));
    }
    ...
    public void testDataPropertiesExact4() throws Exception {
        ...
        List<String> clauses = getDLClauses();
        assertContainsAll(this.getName(), clauses, S(
                ":A(X) v Y1 == Y2 v Y1 == Y3 v Y2 == Y3 v atLeast(4 :dp xsd:integer)(X) v not(xsd:integer)(Y1) v not(xsd:integer)(Y2) v not(xsd:integer)(Y3) :- :dp(X,Y1), :dp(X,Y2), :dp(X,Y3)"));
    }
